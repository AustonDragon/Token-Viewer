...
- **状态栏实时显示** - 在 VSCode 底部状态栏显示剩余 Token，支持千分位格式
- **使用百分比** - 同时显示 Token 剩余百分比（如 `1,234,567 (45.2%)`）
- **自动定时刷新** - 默认每 5 分钟自动刷新，可自定义间隔
...
| `tokenViewer.refreshInterval` | 刷新间隔（秒） | `300` |
